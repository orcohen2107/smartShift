...
import { useConstraints } from '@/features/constraints/contexts/ConstraintsContext';
...
import type { ConstraintInput, ConstraintMode } from '@/features/constraints/types';
import {
  DAY_NAMES_HE,
  formatDateHe,
  getCurrentWeekRange,
} from '@/features/constraints/utils';
import { DeleteChoiceModal } from '@/features/constraints/components/DeleteChoiceModal';
  ...
  return (
    <div className="animate-fade-in relative min-w-0 space-y-5">
      ...
      {deleteChoiceConstraint && (
        <DeleteChoiceModal
          constraint={deleteChoiceConstraint}
          deleting={deletingId === deleteChoiceConstraint.id}
          onDeleteSingle={() => {
          ...
          onCancel={() => setDeleteChoiceConstraint(null)}
        />
      )}
